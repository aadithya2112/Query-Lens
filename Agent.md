...
- Current engineering priority: Stage 1 engine foundations are complete; ship `breakdown` as the next user-visible slice
...
- Do not present dataset onboarding, `breakdown`, `compare`, or `weekly briefing` as shipped yet
